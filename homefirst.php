...
<?php $sli=mysqli_query($con,"SELECT * FROM slider order by id_slider desc limit 4");while($der=mysqli_fetch_array($sli)){ ?>
...
<?php $ur++; } ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                <img style="width:40%;height:40%;margin-left:20px;" src="images/pendukung/logo-himasi-fix-copy-1.png">
                                <img style="width:40%;height:40%;margin-left:20px;" src="images/pendukung/utm.png">
                                <img style="width:40%;height:40%;margin-left:20px;" src="images/pendukung/logo.png">
                            </div>
                            <div class="row">
